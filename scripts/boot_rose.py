...
platform_proc 	= subprocess.Popen("""screen -S platform -p 0 -X stuff 'roslaunch  ${ROSE_LAUNCH}/platform.launch\015'""".format(version=version), 
...
body_proc 		= subprocess.Popen("""screen -S body -p 0 -X stuff 'roslaunch ${ROSE_LAUNCH}/body.launch\015'""".format(version=version), 
                                    stdout=subprocess.PIPE, shell=True)
print roscore_proc.stdout.read()
